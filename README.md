...
A smarts contract that allows users to stakes ERC20 tokens and earn rewards in another ERC20 token over times and based on the number of the blocks passed and the amounts staked.
